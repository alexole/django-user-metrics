...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MetricWeek.unique_count'
        db.add_column('user_metrics_metricweek', 'unique_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MetricDay.unique_count'
        db.add_column('user_metrics_metricday', 'unique_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MetricWeek.unique_count'
        db.delete_column('user_metrics_metricweek', 'unique_count')

        # Deleting field 'MetricDay.unique_count'
        db.delete_column('user_metrics_metricday', 'unique_count')
